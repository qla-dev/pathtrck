...
export const CustomerDetails = ({
  ...
  return (
    ...
    >
      ...
      >
        <header className="h-16 shrink-0 flex items-center justify-between border-b border-slate-200 px-5 dark:border-slate-800 md:px-7">
          <div className="min-w-0">
            ...
            <h2
              ...
              className="truncate text-base font-black text-slate-900 dark:text-white md:text-lg leading-tight mt-0.5"
            >
              {display(name)}
            </h2>
          </div>

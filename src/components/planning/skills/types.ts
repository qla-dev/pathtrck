 ...
 */
export type SkillName = 'inspect' | 'unit' | 'carry' | 'interact_eachother' | 'avoid' | 'aside' | 'consult' | 'receive' | 'leave_room' | 'roam_hall' | 'visit_room' | 'fix_truck' | 'inspect_container' | 'docking';

...
import { AlertTriangle, Anchor, LocateFixed, Maximize2, Minimize2, RefreshCw, Search, Ship, X } from 'lucide-react';
...
export const VesselView = ({ lang }: { lang: Language }) => {
  ...
  return <div ref={containerRef} className="relative h-full min-h-0 overflow-hidden bg-slate-100 dark:bg-slate-950">
    ...
    {selected && <TransportDetails kind="vessel" id={selected.mmsi} lang={lang} variant="modal" onClose={() => setSelectedMmsi(null)} />}

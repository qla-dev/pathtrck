...
const COPY = {
  en: {
    title: 'Platform Command Center', subtitle: 'Live visibility across logistics and warehouse operations stored in Freightbook.ai.', connected: 'DATABASE CONNECTED', logistics: 'Logistics companies', warehouseCompanies: 'Warehouse companies', drivers: 'Carriers', customers: 'Customers', transit: 'In transit', exchange: 'In exchange', events: 'Tracking events', invoices: 'Open invoices', capacity: 'Warehouse capacity', pending: 'Pending warehouses', vehicles: 'Fleet vehicles', active: 'Active loads', utilization: 'Carrier utilization', delivery: 'On-time delivery', loadActivity: 'Load activity', last7: 'Last 7 days', loadStatus: 'Load status overview', driverPerformance: 'Carrier performance', activeDrivers: 'Active carriers', utilizationRate: 'Utilization rate', topDrivers: 'Top carriers by deliveries', seeDrivers: 'View all carriers', fleetStatus: 'Fleet status overview', totalVehicles: 'Total vehicles', vehicleUtilization: 'Vehicle utilization', averageUtilization: 'Average utilization', vehicleTypes: 'Top vehicle types', routeRegion: 'Loads by route region', warehouseUtilization: 'Warehouse utilization (by occupancy)', incomingOutgoing: 'Incoming vs Outgoing pallets', recentTracking: 'Recent tracking events', alerts: 'Alerts & notifications', seeWarehouses: 'View all warehouses', seeTracking: 'View all tracking', seeAlerts: 'View all alerts', occupied: 'Occupied', available: 'Available', todayIncoming: 'Today incoming', todayOutgoing: 'Today outgoing', stockChange: 'In stock change', thisMonth: 'This month', warehouse: 'Warehouse', incoming: 'Incoming', outgoing: 'Outgoing', totalLoads: 'Total loads',
  },
  bs: {
    title: 'Komandni centar platforme', subtitle: 'Pregled logističkih i skladišnih operacija uživo u Freightbook.ai.', connected: 'BAZA POVEZANA', logistics: 'Logističke kompanije', warehouseCompanies: 'Skladišne kompanije', drivers: 'Prevoznici', customers: 'Kupci', transit: 'U tranzitu', exchange: 'Na berzi', events: 'Praćenja', invoices: 'Otvorene fakture', capacity: 'Kapacitet skladišta', pending: 'Skladišta na čekanju', vehicles: 'Vozila flote', active: 'Aktivni tereti', utilization: 'Iskorištenost prevoznika', delivery: 'Isporuka na vrijeme', loadActivity: 'Aktivnost tereta', last7: 'Zadnjih 7 dana', loadStatus: 'Pregled statusa tereta', driverPerformance: 'Učinak prevoznika', activeDrivers: 'Aktivni prevoznici', utilizationRate: 'Stopa iskorištenosti', topDrivers: 'Najbolji prevoznici po isporukama', seeDrivers: 'Pogledaj sve prevoznike', fleetStatus: 'Pregled statusa flote', totalVehicles: 'Ukupno vozila', vehicleUtilization: 'Iskorištenost vozila', averageUtilization: 'Prosječna iskorištenost', vehicleTypes: 'Najčešći tipovi vozila', routeRegion: 'Tereti po regiji rute', warehouseUtilization: 'Iskorištenost skladišta (po zauzeću)', incomingOutgoing: 'Ulazne i izlazne palete', recentTracking: 'Nedavna praćenja', alerts: 'Upozorenja i obavijesti', seeWarehouses: 'Pogledaj sva skladišta', seeTracking: 'Pogledaj sva praćenja', seeAlerts: 'Pogledaj sva upozorenja', occupied: 'Zauzeto', available: 'Dostupno', todayIncoming: 'Danas ulaz', todayOutgoing: 'Danas izlaz', stockChange: 'Promjena zaliha', thisMonth: 'Ovaj mjesec', warehouse: 'Skladište', incoming: 'Ulaz', outgoing: 'Izlaz', totalLoads: 'Ukupno tereta',
  },
  de: {
    title: 'Plattform-Kommandozentrale', subtitle: 'Live-Überblick über Logistik- und Lagerabläufe in Freightbook.ai.', connected: 'DATENBANK VERBUNDEN', logistics: 'Logistikunternehmen', warehouseCompanies: 'Lagerunternehmen', drivers: 'Frachtführer', customers: 'Kunden', transit: 'Im Transport', exchange: 'In der Börse', events: 'Tracking-Ereignisse', invoices: 'Offene Rechnungen', capacity: 'Lagerkapazität', pending: 'Ausstehende Lager', vehicles: 'Flottenfahrzeuge', active: 'Aktive Ladungen', utilization: 'Frachtführerauslastung', delivery: 'Pünktliche Lieferung', loadActivity: 'Ladungsaktivität', last7: 'Letzte 7 Tage', loadStatus: 'Ladungsstatus', driverPerformance: 'Frachtführerleistung', activeDrivers: 'Aktive Frachtführer', utilizationRate: 'Auslastungsrate', topDrivers: 'Top-Frachtführer nach Lieferungen', seeDrivers: 'Alle Frachtführer anzeigen', fleetStatus: 'Flottenstatus', totalVehicles: 'Fahrzeuge gesamt', vehicleUtilization: 'Fahrzeugauslastung', averageUtilization: 'Durchschnittliche Auslastung', vehicleTypes: 'Top-Fahrzeugtypen', routeRegion: 'Ladungen nach Routenregion', warehouseUtilization: 'Lagernutzung (nach Belegung)', incomingOutgoing: 'Ein- und ausgehende Paletten', recentTracking: 'Neueste Tracking-Ereignisse', alerts: 'Warnungen & Benachrichtigungen', seeWarehouses: 'Alle Lager anzeigen', seeTracking: 'Alle Trackings anzeigen', seeAlerts: 'Alle Warnungen anzeigen', occupied: 'Belegt', available: 'Verfügbar', todayIncoming: 'Heute eingehend', todayOutgoing: 'Heute ausgehend', stockChange: 'Bestandsänderung', thisMonth: 'Dieser Monat', warehouse: 'Lager', incoming: 'Eingehend', outgoing: 'Ausgehend', totalLoads: 'Ladungen gesamt',
  },
} as const;
...
export const EuropeHeatMap = ({ values, className = 'h-[132px] w-full' }: { values: Map<string, number>; className?: string }) => {
  const peak = Math.max(1, ...values.values());
  return <svg viewBox="420 188 195 178" className={className} role="img" aria-label="Europe loads by country">
...
export const AdminOverviewView = ({ lang }: { lang: Language }) => {
  ...
  const metrics = [[t.logistics, number(totals.companies), Building2, 'bg-violet-100 text-violet-500 dark:bg-violet-500/10'], [t.warehouseCompanies, number(totals.warehouses), Warehouse, 'bg-orange-100 text-orange-500 dark:bg-orange-500/10'], [t.drivers, number(totals.drivers), Users, 'bg-sky-100 text-sky-500 dark:bg-sky-500/10'], [t.customers, number(totals.customers), Users, 'bg-fuchsia-100 text-fuchsia-500 dark:bg-fuchsia-500/10'], [t.transit, number(totals.transit), Box, 'bg-cyan-100 text-cyan-500 dark:bg-cyan-500/10'], [t.exchange, number(totals.exchange), PackageCheck, 'bg-emerald-100 text-emerald-500 dark:bg-emerald-500/10'], [t.events, number(totals.events), Activity, 'bg-blue-100 text-blue-500 dark:bg-blue-500/10'], [t.invoices, number(totals.invoices), ReceiptText, 'bg-amber-100 text-amber-500 dark:bg-amber-500/10']] as const;
  const operations = [[t.capacity, `${number(totals.capacity)} pal.`, Warehouse, 'bg-violet-100 text-violet-500 dark:bg-violet-500/10'], [t.pending, number(totals.pending), MapPin, 'bg-orange-100 text-orange-500 dark:bg-orange-500/10'], [t.vehicles, number(totals.vehicles), Truck, 'bg-amber-100 text-amber-500 dark:bg-amber-500/10'], [t.active, number(totals.loads), Box, 'bg-blue-100 text-blue-500 dark:bg-blue-500/10'], [t.utilization, `${driverUtilization}%`, Gauge, 'bg-violet-100 text-violet-500 dark:bg-violet-500/10'], [t.delivery, `${onTimeDelivery}%`, ShieldCheck, 'bg-teal-100 text-teal-500 dark:bg-teal-500/10']] as const;
  ...
  const alerts = useMemo(() => {
    ...
    if (crowded) rows.push({ title: 'High warehouse occupancy', note: `${crowded} warehouse${crowded === 1 ? '' : 's'} over 90% capacity`, time: 'live', tone: 'text-red-500', bg: 'bg-red-50 dark:bg-red-500/10', icon: AlertTriangle });
    if (maintenance) rows.push({ title: 'Maintenance due', note: `${maintenance} vehicle${maintenance === 1 ? '' : 's'} require maintenance`, time: 'live', tone: 'text-orange-500', bg: 'bg-orange-50 dark:bg-orange-500/10', icon: AlertTriangle });
    if (overdue) rows.push({ title: 'Overdue invoices', note: `${overdue} invoice${overdue === 1 ? '' : 's'} past due`, time: 'live', tone: 'text-blue-500', bg: 'bg-blue-50 dark:bg-blue-500/10', icon: FileClock });
    if (pendingWarehouses) rows.push({ title: 'Warehouse approval', note: `${pendingWarehouses} warehouse${pendingWarehouses === 1 ? '' : 's'} pending review`, time: 'live', tone: 'text-amber-500', bg: 'bg-amber-50 dark:bg-amber-500/10', icon: Warehouse });
    return rows;

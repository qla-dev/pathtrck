...
const TASKS: Record<string, Record<Locale, Phrase>> = {
  ...
  assign_driver_and_vehicle: {
    en: { label: 'Assign driver', action: 'assign a driver' },
    bs: { label: 'Dodjela vozača', action: 'dodijeliti vozača' },
    de: { label: 'Fahrer zuweisen', action: 'einen Fahrer zuweisen' },
  },
  confirm_pickup_time: {
  ...
  shipping_line_and_agent: {
    en: { label: 'Agent information', action: 'enter the agent information' },
    bs: { label: 'Podaci agenta', action: 'unijeti podatke agenta' },
    de: { label: 'Agenteninformationen', action: 'die Agenteninformationen eingeben' },
  },
  vessel_and_voyage: {
    en: { label: 'Vessel', action: 'enter the vessel' },
    bs: { label: 'Brod', action: 'unijeti brod' },
    de: { label: 'Schiff', action: 'das Schiff eingeben' },
  },
  container_details: {
    en: { label: 'Container number', action: 'enter the container number' },
    bs: { label: 'Broj kontejnera', action: 'unijeti broj kontejnera' },
    de: { label: 'Containernummer', action: 'die Containernummer angeben' },
  },
...
const HINTS: Record<string, Record<Locale, string>> = {
  ...
  shipping_line_and_agent: {
    ...
    bs: 'Unesi naziv kompanije, radno mjesto, e-mail, broj telefona i ime agenta.',
    de: 'Gib Firmenname, Position, E-Mail, Telefonnummer und Name des Agenten ein.',
  },
  vessel_and_voyage: {
    en: 'Search by vessel name or 9-digit MMSI and select the matching vessel.',
    bs: 'Pretraži po nazivu broda ili MMSI-u od 9 cifara i odaberi odgovarajući brod.',
    de: 'Suche nach Schiffsname oder 9-stelliger MMSI und wähle das passende Schiff.',
  },
  container_details: {
    en: 'Enter the container number.',
    bs: 'Upiši broj kontejnera.',
  ...
  airline_and_agent: {
    en: 'Enter the company name, job title, email, phone number, agent name and address.',
    bs: 'Unesi naziv kompanije, radno mjesto, e-mail, broj telefona, ime agenta i adresu.',

...
const mapDatabaseRecordToLoad = (record: Record<string, unknown>): Load => {
  ...
  return {
    ...
    transportType: record.transport_type === 'warehouse' ? 'warehouse' : record.transport_type === 'air' ? 'air' : record.transport_type === 'sea' ? 'sea' : record.transport_type === 'rail' ? 'rail' : 'road',
    ...
    storageServices: Array.isArray(record.handling_requirements) ? record.handling_requirements.map(String) : [],
    storageRateUnit: record.rate_unit == null ? undefined : String(record.rate_unit),
